...
def main():
    ...
    servoPan = AngularServo(12, min_pulse_width=0.0006, max_pulse_width=0.0024)
    servoTilt = AngularServo(13, min_pulse_width=0.0006, max_pulse_width=0.0024)
    ...
    servoPan.value = .7
    servoTilt.value = .7 
    print("Moving servos to extremes...")
    time.sleep(5)
    servoPan.value = -.7
    servoTilt.value = -.7
